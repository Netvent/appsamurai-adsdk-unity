...
SWIFT_CLASS("_TtC15AppSamuraiAdSDK12ASBannerView")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) ASRewardBasedVideoAd * _Nonnull instance;)
+ (ASRewardBasedVideoAd * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT;
+ (void)setInstance:(ASRewardBasedVideoAd * _Nonnull)value;
@property (nonatomic, readonly, copy) NSString * _Nullable adUnitID;
@property (nonatomic, strong) id <ASRewardBasedVideoAdDelegate> _Nullable delegate;
@property (nonatomic, readonly) BOOL isReady;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (void)loadAdWithAdUnitID:(NSString * _Nonnull)adUnitID adRequest:(ASAdRequest * _Nullable)adRequest;
- (void)presentWithRootViewController:(UIViewController * _Nonnull)rootViewController;
@end
